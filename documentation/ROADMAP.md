...
>
> **Recommended sequencing:** close **SELFCHECK-F3** first (cheap, and the first P3.7 deploy
> already proved live behaviour can differ from tests — see
> `docs/operations/incidents/2026-09-13-admin-api-crashloop.md`), then the gate rows **3.8a** and
> **3.14**, then the polish tier. Keep the Tier ⑤ sprint (3.16–3.19) together in one stretch
