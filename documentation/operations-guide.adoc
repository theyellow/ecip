...
addresses (including the `169.254.169.254` cloud-metadata IP), IPv6 unique-local addresses, the
wildcard address, and multicast/reserved ranges — unwrapping IPv4-mapped IPv6 addresses first. The
