# Enterprise Messenger Community Intelligence Platform – Consolidated Architecture Document
...
### Short Description:
An enterprise-grade, microservice-based platform built on Java 25 and Spring Boot 4 that analyzes Messenger (for the moment just Telegram) groups, channels, and discussion threads in real time, detects communication contexts, and reacts based on rules. Unlike traditional bots, the system is TDLib-first, meaning it operates as a full Telegram client. The Bot API remains an optional additional channel.
...
-	Java 25
-	Spring Boot 4 (including Security, WebFlux, Data, Actuator)
...
[1] https://core.telegram.org/tdlib/getting-started
[2] https://core.telegram.org
[3] https://core.telegram.org/tdlib/docs/
[4] https://core.telegram.org/tdlib/docs/classtd_1_1_client.html
[5] https://pub.dev/documentation/tdlib/latest/
[6] https://github.com/spring-projects/spring-boot/wiki/Spring-Boot-4.0-Migration-Guide
[7] https://docs.rs/rust-tdlib
[8] https://www.margo.com/en/home/spring-boot-4-migration-guide/
[9] https://stackoverflow.com/questions/74663442
[10] https://www.reddit.com/r/SpringBoot/comments/1p5d42q/
