...
/**
 * Repository for MessageThread entities. Provides CRUD operations and custom queries for thread
 * management.
 */
@Repository
public interface MessageThreadRepository extends JpaRepository<MessageThread, Long> {
    ...
    @Transactional
    @Query(
            "UPDATE MessageThread t SET t.lastMessageAt = :timestamp WHERE t.telegramChatId ="
                    + " :chatId")
