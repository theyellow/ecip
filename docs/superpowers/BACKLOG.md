...
| 29 | **Admin UI v2: page redesigns** | L | Redesign remaining pages to v2. Each page S-sized, incremental. Status: ✅ Tenants (PR #91) · ⏳ AuditLog, PolicyRules · Remaining: Flags (needs SegmentedControl, ChipRow, ReplyComposer v2), ModerationRules, Telegram, AIConfig, Simulate, Users, Login. Depends on #28. |
