...
/** Policy evaluation service. Implements deterministic rule-based policy decisions. */
@Service
public class PolicyEvaluationService {
    ...
    private record PolicyRule(
            String id, String name, PolicyCondition condition, String action, String reason) {}
